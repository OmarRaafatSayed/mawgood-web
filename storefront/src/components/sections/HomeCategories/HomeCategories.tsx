...
export function HomeCategories({ 
  ...
  const defaultCategories = [
    { id: '1', name: 'الإلكترونيات', handle: 'electronics', icon: '📱' },
    { id: '2', name: 'أزياء نسائية', handle: 'fashion-women', icon: '👗' },
    { id: '3', name: 'أزياء رجالية', handle: 'fashion-men', icon: '👔' },
    { id: '4', name: 'أطفال', handle: 'kids', icon: '🧒' },
    { id: '5', name: 'جمال وعناية', handle: 'beauty', icon: '💄' },
    { id: '6', name: 'منزل ومطبخ', handle: 'home', icon: '🏠' },
    { id: '7', name: 'ألعاب', handle: 'toys', icon: '🎮' },
    { id: '8', name: 'رياضة', handle: 'sports', icon: '⚽' },
  ]
  ...
  return (
    <section className="py-6 w-full">
      ...
      <div className="relative lg:hidden">
        ...
        <button 
          onClick={() => scroll('left')}
          className="absolute left-0 top-1/2 -translate-y-1/2 w-8 h-8 bg-white shadow-md rounded-full flex items-center justify-center z-10"
        >
