...
export const ProductSidebar = () => {
  ...
  return (
    <aside className="relative w-full" data-testid="sidebar">
      <div
        className={cn(
      ...
      >
        {filterModal && (
          <div className="md:hidden">
            <div className="mb-4 flex items-center justify-between border-y p-4" data-testid="sidebar-filter-header">
              <h3 className="heading-md uppercase">{t('filters')}</h3>
              <div onClick={() => setFilterModal(false)} className="cursor-pointer" data-testid="sidebar-close-button">
                <CloseIcon size={20} />
              </div>
            </div>
