...
export const MobileCategoryNavbar = ({
  ...
  return (
    <>
      <nav className="flex flex-col gap-2" aria-label="Mobile category navigation">
        <LocalizedClientLink
          href="/categories"
          onClick={handleClose}
              ...
              <div className="flex items-center justify-between">
                ...
                {hasChildren && (
                  <button
                    ...
                    aria-label={`View ${getCategoryName(handle, name)} subcategories`}
                  >
