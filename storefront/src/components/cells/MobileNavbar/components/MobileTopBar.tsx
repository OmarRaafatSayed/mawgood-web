    ...
    <>
      ...
      >
        <div className="relative flex items-center justify-between px-3 py-2 border-b">
          {/* همبرغر - دايماً في الشمال في LTR وفي اليمين في RTL */}
          <button
          ...
          {/* اللوجو في المنتصف دايماً */}
          <LocalizedClientLink href="/" className="absolute left-1/2 -translate-x-1/2">
          ...
          <div className="flex items-center gap-1">
            ...
            {isLoggedIn && (
              <LocalizedClientLink href="/user/wishlist" className="relative p-2" aria-label={t('wishlist')}>
                <HeartIcon size={20} />
                {wishlistCount > 0 && (
                  <Badge className="absolute -top-1 -end-1 w-4 h-4 p-0 text-[10px]">
                    {wishlistCount}
                  </Badge>
                )}
              </LocalizedClientLink>
        ...
        <div className="lg:hidden fixed inset-0 z-[60] bg-white">
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto p-4">
              <p className="text-sm text-gray-500 mb-4">{tSearch('trending')}</p>
                ...
                {[
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      router.push(`/search?q=${encodeURIComponent(term.label)}`)
                      setIsSearchOpen(false)
                    }}
            ...
            <nav className="p-4">
              {parentCategories.map((parent) => (
                <div key={parent.id} className="border-b py-3">
                  ...
                  >
                    {getCategoryName(parent.handle, parent.name)}
                  </LocalizedClientLink>
