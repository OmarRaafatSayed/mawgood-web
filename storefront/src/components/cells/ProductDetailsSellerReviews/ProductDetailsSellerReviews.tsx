  ...
  return (
    <div className='p-4 border rounded-sm' data-testid="product-seller-reviews-section">
      <div className='flex justify-between items-center mb-5'>
        <h4 className='uppercase heading-sm'>{t('sellerReviews')}</h4>
        <Button variant='tonal' className='uppercase label-md font-400' data-testid="product-seller-reviews-see-more">
          {t('seeMore')}
        </Button>
      </div>
      {reviews.map((review) => (
