...
export async function generateMetadata({
  ...
  try {
    ...
    languages = locales.reduce<Record<string, string>>((acc, code) => {
      acc[toHreflang(code)] = `${baseUrl}/${code}/products`
      return acc
    }, {})
  } catch {
    languages = { [toHreflang(locale)]: `${baseUrl}/${locale}/products` }
  }
  ...
  return {
    ...
    alternates: {
      canonical,
      languages: { ...languages, "x-default": `${baseUrl}/products` },
    },
...
async function AllProducts({
  ...
  return (
    <main className="container px-4 md:px-0">
      ...
      <h1 className="heading-xl uppercase mb-2">All Products</h1>

      <Suspense fallback={<div data-testid="all-products-page-loading"><ProductListingSkeleton /></div>}>
        {bot || !ALGOLIA_ID || !ALGOLIA_SEARCH_KEY ? (
          <ProductListing showSidebar locale={locale} searchParams={resolvedSearchParams} />
        ) : (
