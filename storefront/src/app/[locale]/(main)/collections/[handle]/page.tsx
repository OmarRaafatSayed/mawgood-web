...
const SingleCollectionsPage = async ({
  ...
  const getCollectionName = (handle: string, title: string) => {
    try { return tStyles(handle as any) } catch { return title }
  }
  const collectionDisplayName = getCollectionName(handle, collection.title)
  ...
  return (
    <main className="container">
      ...
      <h1 className="heading-xl uppercase">{collectionDisplayName}</h1>
