...
- Breadcrumbs
- Carousel navigation
- Authentication pages (LoginForm, RegisterForm, ForgotPasswordForm)
- Product listing (ProductListingHeader, ProductListingNoResultsView, ProductSidebar)
- Product filters (PriceFilter, ConditionFilter)
- Product details (ProductDetailsHeader - add to cart, out of stock)
- Cart and checkout flow (CartAddressSection, CartShippingMethodsSection, CartPaymentSection, CartReview, PaymentButton, CartSummary)
- Order confirmed section
- User account pages (UserNavigation, ProfileDetails, ProfilePassword, LogoutButton)
- Order management (OrderDetails, OrderTotals)
- Reviews (ReviewsToWrite, ReviewsWritten, ReviewForm)
- SellNowButton, WishlistButton
