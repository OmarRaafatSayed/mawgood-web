            ...
            children: [
              {
                path: '',
                lazy: async () => {
                  const { Requests } = await import('../../routes/requests/requests-list');
              ...
              },
              {
                ...
                lazy: async () => {
                  const { RequestOrdersList } = await import('../../routes/requests/requests-list');
                ...
                children: [
                  {
                    path: ':id/review',
                    lazy: async () => await import('../../routes/requests/request-order-return')
                  }
                ]
              },
              {
              ...
              },
              {
                ...
                lazy: async () => {
                  ...
                  return {
                    ...
                    loader,
                    handle: {
                      breadcrumb: (match: UIMatch<ExtendedAdminProductResponse>) => (
                        <Breadcrumb {...match} />
                      )
                    }
                  };
                    ...
                    children: [
                      {
                        ...
                        lazy: () => import('../../routes/products/product-additional-attributes')
                      },
                      {
                        path: 'edit',
                      ...
                      {
                        path: 'edit-variant',
                        lazy: () => import('../../routes/product-variants/product-variant-edit')
                      },
                      {
                        path: 'sales-channels',
                      ...
                      },
                      {
                        ...
                        lazy: () => import('../../routes/products/product-shipping-profile')
                      },
                      {
                        path: 'media',
                      ...
                      {
                        path: 'options/create',
                        lazy: () => import('../../routes/products/product-create-option')
                      },
                      {
                      ...
                      },
                      {
                        ...
                        lazy: () => import('../../routes/products/product-create-variant')
                      },
                      {
                        path: 'stock',
                      ...
                      },
                      {
                        ...
                        lazy: () => import('../../routes/products/product-edit-stocks-and-prices')
                      }
                    ]
                  },
                  {
              ...
              },
              {
                ...
                lazy: async () => {
                  ...
                  return {
                    ...
                    loader,
                    handle: {
                      breadcrumb: (match: UIMatch<HttpTypes.AdminProductCategoryResponse>) => (
                        <Breadcrumb {...match} />
                      )
                    }
                  };
                ...
                children: [
                  ...
                  {
                    path: 'metadata/edit',
                    lazy: () => import('../../routes/categories/categories-metadata')
                  }
                ]
              }
            ]
              ...
              },
              {
                ...
                lazy: async () => {
                  ...
                  return {
                    ...
                    loader,
                    handle: {
                      breadcrumb: (match: UIMatch<ExtendedAdminOrderResponse>) => (
                        <Breadcrumb {...match} />
                      )
                    }
                  };
            ...
            children: [
              ...
              },
              {
                ...
                children: [
                  {
                    path: 'edit',
                    lazy: () => import('../../routes/promotions/promotion-edit-details')
                  },
                  {
                    path: 'add-to-campaign',
                    lazy: () => import('../../routes/promotions/promotion-add-campaign')
                  },
                  {
                    path: ':ruleType/edit',
              ...
              },
              {
                ...
                lazy: async () => {
                  ...
                  return {
                    ...
                    loader,
                    handle: {
                      breadcrumb: (match: UIMatch<HttpTypes.AdminCampaignResponse>) => (
                        <Breadcrumb {...match} />
                      )
                    }
                  };
                ...
                children: [
                  ...
                  {
                    path: 'add-promotions',
                    lazy: () => import('../../routes/campaigns/add-campaign-promotions')
                  }
                ]
              }
            ]
            ...
            children: [
              ...
              },
              {
                ...
                children: [
                  {
                    path: 'products',
                    lazy: () => import('../../routes/collections/collection-add-products')
                  },
                  {
                    path: 'metadata/edit',
              ...
              },
              {
                ...
                lazy: async () => {
                  ...
                  return {
                    ...
                    loader,
                    handle: {
                      breadcrumb: (match: UIMatch<HttpTypes.AdminCustomerResponse>) => (
                        <Breadcrumb {...match} />
                      )
                    }
                  };
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    lazy: () => import('../../routes/customers/customers-add-customer-group')
                  },
                  {
                    path: 'metadata/edit',
            ...
            children: [
              {
                ...
                children: [
                  {
                    path: 'create',
                    lazy: () => import('../../routes/customer-groups/customer-group-create')
                  }
                ]
              },
              {
                ...
                lazy: async () => {
                  ...
                  return {
                    ...
                    loader,
                    handle: {
                      breadcrumb: (match: UIMatch<HttpTypes.AdminCustomerGroupResponse>) => (
                        <Breadcrumb {...match} />
                      )
                    }
                  };
                ...
                children: [
                  {
                    path: 'edit',
                    lazy: () => import('../../routes/customer-groups/customer-group-edit')
                  },
                  {
                    path: 'add-customers',
                    lazy: () => import('../../routes/customer-groups/customer-group-add-customers')
                  },
                  {
                    path: 'metadata/edit',
                    lazy: () => import('../../routes/customer-groups/customer-group-metadata')
                  }
                ]
              }
            ]
              ...
              },
              {
                ...
                lazy: async () => {
                  ...
                  return {
                    ...
                    loader,
                    handle: {
                      breadcrumb: (match: UIMatch<HttpTypes.AdminReservationResponse>) => (
                        <Breadcrumb {...match} />
                      )
                    }
                  };
                ...
                children: [
                  ...
                  {
                    path: 'metadata/edit',
                    lazy: () => import('../../routes/reservations/reservation-metadata')
                  }
                ]
              }
            ]
              ...
              },
              {
                ...
                lazy: async () => {
                  ...
                  return {
                    ...
                    loader,
                    handle: {
                      breadcrumb: (match: UIMatch<HttpTypes.AdminInventoryItemResponse>) => (
                        <Breadcrumb {...match} />
                      )
                    }
                  };
        ...
        children: [
                ...
                children: [
                  {
                    ...
                    children: [
                      {
                        path: 'create',
                        lazy: () => import('../../routes/shipping-profiles/shipping-profile-create')
                      }
                    ]
                  },
                  {
                    ...
                    children: [
                      ...
                      },
                      {
                        ...
                        children: [
                          {
                            path: 'edit',
                            lazy: () => import('../../routes/locations/location-service-zone-edit')
                          },
                          {
                            path: 'areas',
                            lazy: () =>
          ...
          },
          {
            ...
            children: [
              {
                path: '',
                lazy: () => import('../../routes/workflow-executions/workflow-execution-list')
              },
              {
                path: ':id',
                lazy: async () => {
            ...
            children: [
              {
                ...
                children: [
                  {
                    path: '',
                    lazy: () => import('../../routes/api-key-management/api-key-management-list'),
                    children: [
                      {
                        path: 'create',
                        lazy: () =>
              ...
              },
              {
                ...
                lazy: async () => {
                  ...
                  return {
                    ...
                    loader,
                    handle: {
                      breadcrumb: (match: UIMatch<HttpTypes.AdminApiKeyResponse>) => (
                        <Breadcrumb {...match} />
                      )
                    }
                  };
                ...
                children: [
                  {
                    path: 'edit',
                    lazy: () => import('../../routes/api-key-management/api-key-management-edit')
                  },
                  {
                    path: 'sales-channels',
                    lazy: () =>
